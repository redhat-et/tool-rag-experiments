...
# Patch for PyTorch 2.6+ safe unpickling
...
def train(args):
    torch.serialization.add_safe_globals([TripletDataset])
    dataset = torch.load(args.train_data_path, weights_only=False)
    ...
    for epoch in range(num_epochs):
        ...
        for batch in tqdm.tqdm(dataloader):
            ...
            # Log the loss
            if args.wandb_name and current_step:
                wandb.log(
                    {
